...
<section class="Hui-container">	
	...
	<h2>详细信息</h2>
		...
		<br>
		<br>
		<form method="post" action="<?php echo U('Sreserve/reserve');?>" id="sreserve_form" class="form form-horizontal responsive">	
			<div class="row cl">
				<label class="form-label col-xs-2">大学：</label>
				<div class="formControls col-xs-5"> 
				<span class="select-box">
					<select class="select" size="1" name="college" id="college" datatype="*" nullmsg="请选你就读的大学！">
						<option value="" selected>请选择你就读的大学</option>
			...
			<div class="row cl">		
				...
				<div class="formControls col-xs-5"> 
				<span class="select-box">
					<select class="select" size="1" id ="department" name="department" datatype="*" nullmsg="请选择所属学院！">
						<option value="" selected>请选择你所在的学院</option>
						<option value="1">social sciences & management</option>
						<option value="2">arts and humanities</option>
						<option value="3">natural sciences</option>
						<option value="4">life sciences & medicine</option>
			...
			<br>
			<div class="row cl">				
				<label class="form-label col-xs-2">入学时间：</label>
				<div class="formControls col-xs-5"> 
				<span class="select-box">
					<select class="select" size="1" name="start_year" id="start_year" datatype="*" nullmsg="请选择入学时间！">
						<option value="" selected>请选择你入学时间</option>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-5">
					<input type="text" class="input-text" placeholder="请填写你的专业" name="major" id="major" datatype="major" nullmsg="专业不能为空">
				</div>
				<div class="col-xs-5"> </div>
			</div>
			<!--  
			...
			<br>
			<div class="row cl">
				<label class="form-label col-xs-2">护照号：</label>
				<div class="formControls col-xs-5">
					<input type="text" class="input-text" placeholder="护照号码" name="passport" id="passport" datatype="passport" nullmsg="护照不能为空">
				</div>
				<div class="col-xs-5"> </div>
			</div>
			<br>
			<div class="row cl">
				<label class="form-label col-xs-2">身份证号码：</label>
				<div class="formControls col-xs-5">
					<input type="text" class="input-text" placeholder="身份证号码" name="idcard" id="idcard" datatype="idcard" nullmsg="身份证号不能为空">
				</div>
				<div class="col-xs-5"> </div>
			</div>
			<br>
			<div class="row cl">
				<label class="form-label col-xs-2">预约贷款金额：</label>
				<div class="formControls col-xs-5">
					<input type="text" class="input-text" placeholder="人民币" name="loan" id="loan" datatype="loan" nullmsg="请输入金额">
				</div>
				<div class="col-xs-5"> </div>
			</div>	
			<br>
			...
			<div class="row cl">
				...
				<div class="formControls skin-minimal col-xs-5">
					<div class="check-box">
						...
						我授权Brilliance Finance向我的大学询问我的个人信息（成绩等），以便Brilliance Finance对我的贷款进行评估
					</div>
			...
			<div class="row cl">
				...
				<div class="formControls skin-minimal col-xs-5">
					<div class="check-box">
						<input type="checkbox" id="checkbox-6" name="checkbox3" datatype="*" nullmsg="请勾选注册及服务协议。">
						<label for="checkbox-6"></label>
						我授权我的大学向Brilliance Finane提供任何有关贷款评估的个人信息
					</div>
