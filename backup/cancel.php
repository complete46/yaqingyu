...
$sql = "select FLIGHT_ID, BOOKING_ID from BOOKING WHERE CUST_ID = '".$userid."'";
$result1 = mysql_query($sql);
//Show flights to cancel
echo "<hr />";
...
while ($row2 = mysql_fetch_array($result1)) {
    ...
    echo "<tr>";
    echo "<td>" . $row[1] . "</td><td>" . $row[2] . "</td><td>" . $row[3] . "</td><td>" . $row[4] . "</td><td>" . ($row[6] - $row[5]) . "</td><td><a href = \"confirmcancel.php?data=$row2[1]\">Cancel this ticket</a></td>";
    echo "</tr>";
}
echo "</table>";
